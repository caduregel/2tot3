...
const HomePage = () => {
    return (
        <body>
            <div className="flex pt-10 pl-60 pr-60 pb-10 bg-slate-700 text-white">
                ...
                <img src="/beta-text-icon.svg" alt="" className="w-100 h-100" />
            </div>


            <div className="flex flex-col items-center pt-10 pb-10 pl-100 pr-100 mb-15 ">
            ...
            <div className="flex flex-col pt-20 pb-20 pl-80 pr-80 items-center bg-zinc-200 mb-15">
